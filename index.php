<?php
$admin = 605778538';
$token = '838305795:AAHSg4piHhd-14Lohq6fDfjN2QkHm6heUnU';
...
if((mb_stripos($data,"$calltok=👎")!==false) and (mb_stripos($calluser,"php_owners")!==false)){
bot('sendmessage',[
    'chat_id'=>'-1001368733588',
    'text'=>"📡 Kanal: @$calluser
📎 Post: t.me/$calluser/$cmid
👤 Foydalanuchi: @$callfrusername
✍️ Fikri: 👎 $des",
    'parse_mode'=>"html",
...
if((mb_stripos($data,"$calltok=👎")!==false) and (mb_stripos($calluser,"php_own")!==false)){
bot('sendmessage',[
    'chat_id'=>'-1001368733588',
    'text'=>"📡 Kanal: @$calluser
📎 Post: t.me/$calluser/$cmid
...
if((mb_stripos($data,"$calltok=👎")!==false) and (mb_stripos($calluser,"coderuzapi")!==false)){
bot('sendmessage',[
    'chat_id'=>'956573584',
    'text'=>"📡 Kanal: @$calluser
📎 Post: t.me/$calluser/$cmid
...
if((mb_stripos($data,"$calltok=👎")!==false) and (mb_stripos($calluser,"Yosh_Koderlar")!==false)){
bot('sendmessage',[
    'chat_id'=>'-1001287757519',
    'text'=>"📡 Kanal: @$calluser
📎 Post: t.me/$calluser/$cmid
👤 Foydalanuchi: @$callfrusername
✍️ Fikri: 👎 $des",
